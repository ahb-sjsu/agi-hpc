...
def rewrite_header(content: str) -> str:
    ...
    # Append the rest of the file (from first non-comment line)
...
def process_file(path: str, dry_run: bool = False) -> bool:
    ...
    if new_content == original:
        return False  # nothing changed (e.g. weird edge case)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Replace or insert AGI-HPC license header in all Python files."
    )
    parser.add_argument(
        "root",
        nargs="?",
