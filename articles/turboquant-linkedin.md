...
TurboQuant-KV is pip-installable and dependency-light (only NumPy):
...
TurboQuant-KV is MIT-licensed and open source:

- **GitHub:** https://github.com/ahb-sjsu/turboquant-kv
- **PyPI:** https://pypi.org/project/turboquant-kv/
