...
payload = {"title": "Fix for issue #100", "body": "Closes #100\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-100", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/ahb-sjsu/agi-hpc/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
