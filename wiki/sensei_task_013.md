...
**Test example prediction**: Sources at (0,5)=3 and (10,10)=4. col_spacing=5 < row_spacing=10 → horizontal, period=10. Output should have 3 at cols 5,15,25 and 4 at cols 10,20 across all rows.
