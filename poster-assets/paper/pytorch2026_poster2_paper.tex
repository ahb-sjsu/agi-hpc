...
generating the \emph{measured} Klein four-group $V_4$; the full dihedral $D_4$ is a
posited, testable extension, not an established result --- a correction we made to our
own earlier claim and document here. A Bond Index tests whether a judgment survives
...
Our earlier materials (including the originally submitted version of this poster)
claimed the full dihedral group $D_4$ (order 8, non-abelian). That was an overclaim,
and we corrected it in July 2026: $D_4$ is \textbf{posited}, licensed only if
...
against Hugging Face causal LMs, with Qwen- and Gemma-family models exercised in
deployment. Caveat: the activation probe is \emph{uncalibrated by default} --- its
...
\texttt{pip install erisml-compiler}. Source: \texttt{github.com/ahb-sjsu}
(\texttt{erisml-compiler}, \texttt{erisml-lib}, \texttt{agi-hpc}). Zenodo DOIs:
10.5281/zenodo.20659432 (compiler); 10.5281/zenodo.21310251 (COMPAS/LBI analysis
archive).

\begin{thebibliography}{9}\footnotesize\setlength{\parskip}{0pt}\setlength{\itemsep}{1pt}
\bibitem{hohfeld} W.~N.~Hohfeld. \emph{Fundamental Legal Conceptions as Applied in
Judicial Reasoning}. Yale Law Journal, 1917.
\bibitem{bond-tensorial} A.~H.~Bond. \emph{Tensorial Ethics}. 2025.
\bibitem{sqnd} A.~H.~Bond. SQND-Probe: falsification tests for gauge-theoretic
models of moral judgment. 2026.
\bibitem{socialchem} M.~Forbes et al. Social Chemistry 101. EMNLP 2020.
\end{thebibliography}
