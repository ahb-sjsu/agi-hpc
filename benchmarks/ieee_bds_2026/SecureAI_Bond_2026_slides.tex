...
\begin{itemize}
  \item Scorecard: 3 flagged $\rightarrow$ \gold{1 validated} (\texttt{identity\_attack}), \gold{1 retracted} (threat), \gold{1 declined} (sexual content $\rightarrow$ policy channel, not a moral axis). \hi{The gate has teeth.}
