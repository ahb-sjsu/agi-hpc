...
\end{columns}
\vfill
{\tiny Bifactor: learned-encoder instantiation (\texttt{xbse}), 12$\times$12 gate at margin 0.05; \texttt{identity\_attack} divergence recorded, not adjudicated. Panel FA: 6 models $\times$ 3 reps consensus, Horn's parallel analysis, $n{=}31$ --- loadings coarse, the factor count is the robust part. July 2026.}
\end{frame}
